Below are the **4 front scripts** using the same front structure from your previous report: `module_code, submoduletype_code, target_days, on_time_count, total_count, percentage`. 

I used **30 days** as the target for post-approval document upload. Change this line in each script if your SLA is different:
